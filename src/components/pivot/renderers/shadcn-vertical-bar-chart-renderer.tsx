...
export class ShadcnVerticalBarChartRenderer<T extends Record<string, unknown> = Record<string, unknown>>
  implements PivotRenderer<T> {

  readonly id = 'shadcn-bar-chart';
  readonly name = 'Bar Chart';
  readonly type = 'chart' as const;
  readonly description = 'Bar chart visualization with shadcn/ui styling';
...
export const shadcnVerticalBarChartRenderer = new ShadcnVerticalBarChartRenderer();